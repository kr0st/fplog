...
#include "../../libjson.h"
	...
	*/
    ...
    JSON_API json_bool_t json_as_bool(json_const JSONNODE * node){
	   ...
	   JSON_API void * json_decode64(const json_char * text, unsigned long * size){
    ...
    JSON_API JSONNODE * json_at(JSONNODE * node, unsigned int pos){
    ...
    JSON_API JSONNODE * json_pop_back_at(JSONNODE * node, unsigned int pos){
